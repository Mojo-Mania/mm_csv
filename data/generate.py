"""Generates the two benchmark CSVs, matching the shapes in setup.sh.

Deterministic: the same seed gives the same bytes on every machine, so a
timing measured here is comparable with one measured there.
"""
import random
...
write("no_escaping.csv", 255_360,
      ["measure", "quantile", "area", "sex", "age", "geography", "ethnic",
       "value"], 0.0)
write("needs_escaping.csv", 201_181,
